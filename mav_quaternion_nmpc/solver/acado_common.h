...
{
int dummy;
/** Matrix of size: 16 x 13 (row major format)
 * 
 ...
 * 
 *  Matrix containing 15 reference/measurement vectors of size 16 for first 15 nodes.
 */
real_t y[ 240 ];
...
/** Matrix of size: 195 x 13 (row major format) */
real_t evGx[ 2535 ];

/** Matrix of size: 195 x 4 (row major format) */
real_t evGu[ 780 ];
...
/** Matrix of size: 195 x 16 (row major format) */
real_t Q2[ 3120 ];
...
/** Matrix of size: 1560 x 4 (row major format) */
real_t E[ 6240 ];
 ...
 *
 *  \param rk_eta Working array of size 28 to pass the input values and return the results.
